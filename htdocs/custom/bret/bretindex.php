...
/**
 *	\file       htdocs/bret/template/bretindex.php
 *	\ingroup    bret
 *	\brief      Home page of bret top menu
 */
...
if (! $user->rights->bret->read) accessforbidden();
...
llxHeader("",$langs->trans("bretArea"));

print load_fiche_titre($langs->trans("bretArea"),'','bret.png@bret');
...
// Draft MyObject
if (! empty($conf->bret->enabled) && $user->rights->bret->read)
{
	$langs->load("orders");
