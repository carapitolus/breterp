...
/**
 * \file        class/pointage.class.php
 * \ingroup     bret
 * \brief       This file is a CRUD class file for Pointage (Create/Read/Update/Delete)
 */
 ...
 * Class for Pointage
 */
class Pointage extends CommonObject
{
	/**
	 * @var string ID to identify managed object
	 */
	public $element = 'pointage';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'pointage';
	...
	/**
	 * @var array  Does pointage support multicompany module ? 0=No test on entity, 1=Test with field entity, 2=Test with link by societe
	 */
	protected $ismultientitymanaged = 1;
	/**
	 * @var string String with name of icon for pointage
	 */
	public $picto = 'pointage';
	...
	public $fields=array(
		...
		'label' => array('type'=>'varchar(255)', 'label'=>'Label', 'visible'=>1, 'enabled'=>1, 'position'=>30, 'searchall'=>1,),
		'qty' => array('type'=>'double(24,8)', 'label'=>'Qty', 'visible'=>1, 'enabled'=>1, 'position'=>40,),
	 ...
	 */
	//public $table_element_line = 'pointagedet';
	/**
	 * @var int    Field with ID of parent key if this field has a parent
	 */
	//public $fk_element = 'fk_pointage';
	/**
	 * @var int    Name of subtable class that manage subtable lines
	 */
	//public $class_element_line = 'Pointageline';
	/**
	 * @var array  Array of child tables (child tables to delete before deleting a record)
	 */
	//protected $childtables=array('pointagedet');
	/**
	 * @var PointageLine[]     Array of subtable lines
	 */
	//public $lines = array();
	...
	function getNomUrl($withpicto=0, $option='', $notooltip=0, $morecss='')
	{
        ...
        $label = '<u>' . $langs->trans("Pointage") . '</u>';
        $label.= '<br>';
        $label.= '<b>' . $langs->trans('Ref') . ':</b> ' . $this->ref;

        $url = $url = dol_buildpath('/bret/m_card.php',1).'?id='.$this->id;
        ...
        if (empty($notooltip))
        {
            ...
            {
                $label=$langs->trans("ShowPointage");
