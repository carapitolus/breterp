...
/**
 * \file    modulebuilder/template/core/boxes/bretwidget1.php
 * \ingroup bret
 * \brief   Widget provided by bret
 *
 ...
 */
class bretwidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "bretbox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "bret@bret";
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		//$this->hidden = ! ($user->rights->bret->myobject->read);   // Condition when module is visible by user (test on permission)
	}
	...
	public function loadBox($max = 5)
	{
		...
		//include_once DOL_DOCUMENT_ROOT . "/bret/class/bret.class.php";

		// Populate the head at runtime
		$text = $langs->trans("bretBoxDescription", $max);
