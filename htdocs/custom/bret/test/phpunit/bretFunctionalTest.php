...
/**
 * \file    test/functional/bretFunctionalTest.php
 * \ingroup bret
 ...
 * @package Testbret
 */
class bretFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
...
//        )
	...
	{
		$this->url('/custom/bret/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('bret/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/bret/admin/about.php');
		$this->authenticate();
		return $this->assertContains('bret/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('bretwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modbret_bretTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modbret_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
