 ...
 */
class box_projectbret extends ModeleBoxes
{
	var $boxcode="projectbret";
	var $boximg="";
	var $boxlabel;
	...
	*/
	function loadBox($max=10)
	{
		...
		$max=100; // maximum de projet � afficher
		$this->max=$max;
		...
		$textHead = 'BRET MODULE / Projets OUVERTS et BROUILLONS';
		...
		if ($user->rights->projet->lire) {
            ...
            $sql.= " AND p.fk_statut = 1 OR p.fk_statut = 0"; 
