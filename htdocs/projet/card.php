...
if ($action == 'create' && $user->rights->projet->creer)
{
    ...
    $array=array();
    	...
    	// MLA 23/02/2018 : supprimer afin de mettre en visibilite "TOUT LE MONDE"
    ...
    if (empty($conf->global->PROJECT_DISABLE_PUBLIC_PROJECT)) $array[0] = $langs->trans("SharedProject");
